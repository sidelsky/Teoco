...
<?php if( have_rows('video_repeater') ): ?>
	...
	<div class='js-video'>
		...
		<!-- YouTube video -->
		<?php echo "<iframe src='https://www.youtube.com/embed/$video_youtube?wmode=opaque' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen width='100%' height='400'></iframe>"?>
